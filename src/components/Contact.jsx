          ...
          >
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:alberto@example.com" className="text-blue-600 dark:text-blue-400 hover:underline">alberto@example.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+11234567890" className="text-blue-600 dark:text-blue-400 hover:underline">+1 (123) 456-7890</a>
                </div>
              </div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
